...
public class MainActivity extends AppCompatActivity {
    ...
    public class ViewDialogAdd {
        public void showDialog(Context context) {
            ...
            EditText textPlan = dialog.findViewById(R.id.textPlan);
            EditText textComment = dialog.findViewById(R.id.textComment);
            ...
            buttonAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String plan = textPlan.getText().toString();
                    String comment = textComment.getText().toString();

                    if (name.isEmpty() || plan.isEmpty() || comment.isEmpty()) {
                        Toast.makeText(context, "Please Enter All data...", Toast.LENGTH_SHORT).show();
                    } else {
                        databaseReference.child("USERS").child(id).setValue(new UsersItem(id, name, plan, comment));
